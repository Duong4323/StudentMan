...
class MainActivity : AppCompatActivity() {
    ...
    private fun getInitialStudentList() = listOf(
        StudentModel("Nguyễn Bình Dương", "SV101"),
        StudentModel("Trần Thị Ngọc", "SV102"),
        StudentModel("Lê Văn Nam", "SV103"),
        StudentModel("Vũ Văn An", "SV104"),
        StudentModel("Hoàng Thị Oanh", "SV105"),
